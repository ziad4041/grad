...
WIND_VALUES = [
    ...
    "light winds from the S",
    "light winds from the E",
    "light winds from the W",
    "gentle breeze from the N",
    "gentle breeze from the S",
    "moderate breeze from the N",
    "moderate breeze from the S",
    "fresh breeze from the N",
    "fresh breeze from the W",
]
...
def home():
    return jsonify(
        {"message": "Egyptian Railway Delay Predictor API", "version": "1.0"}
    )
